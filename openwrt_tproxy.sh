...
TEMPLATE_URL="https://raw.githubusercontent.com/vnddddd/singboxguize/refs/heads/main/config_tproxy.json"  # 配置文件（规则模板)
#TEMPLATE_URL="https://raw.githubusercontent.com/vnddddd/singboxguize/refs/heads/te1/config_tproxy.json"  # 配置文件（规则模板)
