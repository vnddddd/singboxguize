...
BACKEND_URL="dy2.caoxian1.dynv6.net"  # 转换后端地址
SUBSCRIPTION_URL="https://dy.caoxian1.dynv6.net/4587"  # 订阅地址
TEMPLATE_URL="https://raw.githubusercontent.com/vnddddd/singboxguize/refs/heads/main/config_tun.json"  # 配置文件（规则模板)
...
ip rule add from 192.168.10.151 lookup 2022 priority 8997
ip rule add from 192.168.10.174 lookup 2022 priority 8997
ip rule add from 192.168.10.172 lookup 2022 priority 8997
ip rule add from 192.168.10.0/24 lookup main priority 8998
ip rule add from 192.168.10.0/24 lookup default priority 8999
